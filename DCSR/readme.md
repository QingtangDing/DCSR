...
- Select patches with different complexities and  patches with different texture categories in DIV2K to compose data subsets
- ```bash
...
<p align="center"> <img src="Figs/method.png" width="100%"> </p>
